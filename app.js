import { getDatabase, ref, set, get, onValue, off } from "https://www.gstatic.com/firebasejs/9.6.1/firebase-database.js";
...
function crearTablero() {
    ...
    for (let r = 0; r < tamanyo; r++) {
        for (let c = 0; c < tamanyo; c++){
            ...
            texto.classList.add("celdaTexto");
            texto.textContent = frases[r * tamanyo + c];
